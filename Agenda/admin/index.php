...
extract($_POST);
$con=mysqli_connect('localhost','root','','rfk_agenda');
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <?php include'menu.php'; ?>
                ...
                if(isset($_GET['page'])){
                 switch($_GET['page']){
					case 'agenda': include'form_input_agenda.php'; break;
                    case 'list_agenda': include'list_agenda.php';$order=4; break;
                    
					case 'berita': include'form_input_berita.php'; break;
                    case 'list_berita': include'list_berita.php';$order=3; break;	
					
					case 'lihat_agenda': include'lihat_agenda.php'; break;
					case 'lihat_berita': include'lihat_berita.php'; 
                 }
                }
            ?>
                    </section>
                ...
                <footer class="main-footer">
                    ...
                    <strong> <?php echo "©" . (int)date('Y') . " @Fendi.Randi.Khusnun"; ?>
