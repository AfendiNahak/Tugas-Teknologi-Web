<aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li><a href="index.php?page=lihat_agenda"><i class="glyphicon glyphicon-star-empty"></i> <span>Lihat Agenda</span></a></li>
			
            <li><a href="index.php?page=lihat_berita"><i class="glyphicon glyphicon-star"></i> <span>Lihat Berita</span></a></li>
          </ul>
        </section>
        <!-- /.sidebar -->
</aside>
